...
var circle = L.circle([53.294299,-6.188424], {
    color: 'red',
    fillColor: '#f03',
    fillOpacity: 0.5,
    radius: 15
...
var marker = new L.marker([53.294299,-6.188424], {
    icon: homeIcon
}).bindPopup("Your Bike is at Home").addTo(map);
        ...
        createMarker: function(i, wp) {
            if(i === 0){
                ...
                return L.marker(wp.latLng, {
                    draggable: false,
                    icon: startIcon
                }).bindPopup("Your Bike has left Home, Was this you?");
            }
        },
        show: false,
